 ...
 */
// 超级安全的唯一ID确保方式，尼玛，考虑到自增到了安全点会溢出
function nextUid() {
 ...
 */
// 对URL的字符串进行解析，变成对象 aa=bb&cc=dd => {"aa": "bb", "cc": "dd"}
...
// 对象解析成URL带参数的字符串 {"aa": "bb", "cc": "dd"} => aa=bb&cc=dd
 ...
 *                     / "*" / "+" / "," / ";" / "="
 */
// 把特殊符号转译成实体符号，pctEncodeSpaces判断是否把空格转译成'+'号
...
function angularInit(element, bootstrap) {
  ...
  forEach(elements, function(element) {
    // 只会触发一次
    if (!appElement) {
        // 获取类名 如果是类名就用 class="ng-app: myApp" 否者就用属性 ng-app="myApp"
...
// 工具函数: snake_case('AaBbCc') => aa_bb_cc
