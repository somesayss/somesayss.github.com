...
var NoPermission = function (_Component) {
	_inherits(NoPermission, _Component);

	function NoPermission() {
		_classCallCheck(this, NoPermission);

		return _possibleConstructorReturn(this, (NoPermission.__proto__ || Object.getPrototypeOf(NoPermission)).apply(this, arguments));
	}
	...
	_createClass(NoPermission, [{
		...
		value: function render() {
			...
			return React.createElement(
				'div',
				{ className: me.getClassName('page-no-permission') },
				'pageNoPermission'
			);
		}
	}, {
...
// module
exports.push([module.i, ".page-no-permission{background:red}", ""]);
