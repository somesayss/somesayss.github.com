...
var MobilePage1 = function (_Component) {
	_inherits(MobilePage1, _Component);

	function MobilePage1() {
		_classCallCheck(this, MobilePage1);

		return _possibleConstructorReturn(this, (MobilePage1.__proto__ || Object.getPrototypeOf(MobilePage1)).apply(this, arguments));
	}

	_createClass(MobilePage1, [{
		key: 'render',
		value: function render() {
			...
			return React.createElement(
				'div',
				{ className: me.getClassName('page-mobile-page1') },
				'pageMobilePage1',
				React.createElement(
					'a',
					{ href: '#mobile/page2' },
...
// module
exports.push([module.i, ".page-mobile-page1{background:red}", ""]);
...
var _controller = __webpack_require__(205);
