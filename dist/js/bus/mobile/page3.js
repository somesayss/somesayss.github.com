...
var MobilePage3 = function (_Component) {
	_inherits(MobilePage3, _Component);

	function MobilePage3() {
		_classCallCheck(this, MobilePage3);

		return _possibleConstructorReturn(this, (MobilePage3.__proto__ || Object.getPrototypeOf(MobilePage3)).apply(this, arguments));
	}

	_createClass(MobilePage3, [{
		key: 'render',
		value: function render() {
			...
			return React.createElement(
				'div',
				{ className: me.getClassName('page-mobile-page3') },
				'pageMobilePage3'
			);
		}
	}, {
...
// module
exports.push([module.i, ".page-mobile-page3{background:red}", ""]);
