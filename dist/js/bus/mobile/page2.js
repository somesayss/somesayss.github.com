...
var MobilePage2 = function (_Component) {
	_inherits(MobilePage2, _Component);

	function MobilePage2() {
		_classCallCheck(this, MobilePage2);

		return _possibleConstructorReturn(this, (MobilePage2.__proto__ || Object.getPrototypeOf(MobilePage2)).apply(this, arguments));
	}

	_createClass(MobilePage2, [{
		key: 'render',
		value: function render() {
			...
			return React.createElement(
				'div',
				{ className: me.getClassName('page-mobile-page2') },
				'pageMobilePage2',
				React.createElement(
					'a',
					{ href: '#mobile/page3' },
...
// module
exports.push([module.i, ".page-mobile-page2{background:red}", ""]);
