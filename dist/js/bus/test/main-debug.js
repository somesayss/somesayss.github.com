 ...
 * 业务
 */
define("bus/test/main-debug", [ "common/base-debug", "github/bus/test/config-debug" ], function(require, exports, module) {
    //依赖
    var Base = require("common/base-debug"), config = require("github/bus/test/config-debug");
