 ...
 * 业务类
 */
define("bus/myTrave/main-debug", [ "modules/BaiduMap/main-debug", "./mapMarks-debug" ], function(require, exports, module) {
    // 依赖
    var BaiduMap = require("modules/BaiduMap/main-debug");
    // 类
    var MyTrave = BaiduMap.extend({
        ...
        attrs: {
            // 坐标点
            mapMarks: require("./mapMarks-debug")
        }
    });
    // 接口
 ...
 * 业务类
 */
define("bus/myTrave/mapMarks-debug", [], function(require, exports, module) {
    // 数据
    module.exports = [ {
