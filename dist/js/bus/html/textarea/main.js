...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(11)(__webpack_require__(149), __webpack_require__(152));
		...
		_createClass(Title, [{
			...
			value: function render() {
				...
				return React.createElement(
					'div',
					null,
					React.createElement(Textarea, { value: props.value }),
					React.createElement(Input, { type: 'button', onClick: Actions(me).changeValue, value: '点 击' })
				);
			}
		}]);
