		...
		_createClass(PdfView, [{
			...
			value: function render() {
				...
				return React.createElement(
					'div',
					{ className: me.getClassName('page-pdf-view') },
					'pagePdfView',
					React.createElement('iframe', { src: 'https://www.yuncourt.com/fileOperation/download.json?fileIdStr=Ur2dnaTmWBZq-oEj7ratGA' })
				);
			}
		}, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".page-pdf-view {\n  background: #F00;\n}\n", ""]);
