...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(11)(__webpack_require__(143), __webpack_require__(146));
		...
		_createClass(Title, [{
			...
			value: function render() {
				...
				return React.createElement(
					...
					React.createElement(
						'select',
						{ style: { width: 100 }, multiple: 'true', size: '2', id: 'select', value: ['a1', 'a2'], onChange: function onChange() {} },
						React.createElement(
							'option',
							{ value: 'a1' },
							'a1'
					...
					'  ',
					React.createElement(Input, { type: 'button', value: '更 换', onClick: Actions(me).change })
				);
			}
		}]);
