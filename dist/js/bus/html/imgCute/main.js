...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Title = __webpack_require__(49);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(15)(__webpack_require__(50), __webpack_require__(115));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Mousemove = __webpack_require__(67);
	var FilesDrop = __webpack_require__(91);
	...
	var Imgcute = function (_React$Component) {
		...
		function Imgcute() {
			...
			return _possibleConstructorReturn(this, (Imgcute.__proto__ || Object.getPrototypeOf(Imgcute)).apply(this, arguments));
		}
		...
		_createClass(Imgcute, [{
			...
			value: function render() {
				...
				return React.createElement(
					'div',
					{ className: 'imgcute' },
					React.createElement(FilesDrop, { onDrop: me.drop.bind(me) }),
					React.createElement(Input, { type: 'file', value: '\u9009\u62E9\u56FE\u7247', className: 'fn-ML15', onChange: me.change.bind(me) }),
					React.createElement(Input, { type: 'button', value: '\u9884 \u89C8', className: 'fn-ML15', onClick: me.viewImg.bind(me) }),
					React.createElement(Input, { type: 'button', value: '\u4E0A \u4F20', className: 'fn-ML15', onClick: me.saveImg.bind(me) }),
			...
			key: 'kissFile',
			value: function kissFile(file) {
				var me = this;
				var refs = me.refs;
				var img = refs.img,
				    cute = refs.cute;
	
				me.readFile(file).then(function (url) {
			...
			value: function drawImg(img) {
				...
				var cxt = me.cxt = theCanvas.getContext('2d');
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".imgcute .ch-canvas {\n  display: inline-block;\n  position: relative;\n  overflow: hidden;\n  z-index: 1;\n}\n", ""]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Widget = __webpack_require__(92);
	var originClass = __webpack_require__(15)(__webpack_require__(93), __webpack_require__(107));
	...
	var Cover = function (_React$Component) {
		...
		_createClass(Cover, [{
			...
			value: function componentDidMount() {
				var me = this;
				var refs = me.refs;
				var dropNode = refs.dropNode;
	
				var nameSpace = me.nameSpace = 'drag' + limit.getUid();
				var DOC = me.DOC = $(document);
				dropNode = $(dropNode);
				['dragleave', 'drop', 'dragenter', 'dragover'].map(function (val) {
					DOC.on(val + '.' + nameSpace, me.stop.bind(me));
					return val;
				}).forEach(function (val) {
					dropNode.on(val + '.' + nameSpace, function (e) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".limit-inputdrop {\n  display: inline-block;\n  height: 100px;\n  line-height: 98px;\n  background: #F2F2F2;\n  position: relative;\n  color: #666;\n  border: 1px solid #CCC;\n  padding: 0 10px;\n}\n.limit-inputdrop.limit-inputdrop-dropin {\n  background: #DDD;\n  border-color: #BBB;\n}\n", ""]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(15)(__webpack_require__(111), __webpack_require__(114));
	...
	var Cropper = function (_React$Component) {
		...
		_createClass(Cropper, [{
			...
			value: function getCuteStyle() {
				...
				var backgroundImage = 'url(' + props.src + ')';
				return { width: width, height: height, top: top, left: left, backgroundPosition: backgroundPosition, backgroundImage: backgroundImage };
			}
		}, {
			key: 'render',
			value: function render() {
				...
				return React.createElement(
					'div',
					{ className: me.getClassName(), ref: 'cropperContainer' },
					React.createElement('img', { src: props.src }),
					React.createElement('div', { className: 'cropper-mock' }),
					React.createElement('div', { className: 'cropper-cute',
						ref: 'cute',
						style: me.getCuteStyle(),
						onMouseDown: me.mousedown.bind(me) })
				);
			}
		}, {
			key: 'getTheXY',
			value: function getTheXY(diff, nowX, nowY, maxX, maxY) {
				var theX = nowX + diff.diffX;
				var theY = nowY + diff.diffY;
				if (theX < 0) {
					theX = 0;
				} else if (theX > maxX) {
					theX = maxX;
			...
			value: function mousedown(e) {
				...
				var refs = me.refs;
				var cute = refs.cute,
				    cropperContainer = refs.cropperContainer;
	
				var nowX = parseInt(cute.style.left);
				var maxX = cropperContainer.offsetWidth - cute.offsetWidth;
				var nowY = parseInt(cute.style.top);
				var maxY = cropperContainer.offsetHeight - cute.offsetHeight;
				new Mousemove(e).on('move', function (e, diff) {
					var _me$getTheXY = me.getTheXY(diff, nowX, nowY, maxX, maxY),
					    theX = _me$getTheXY.theX,
					    theY = _me$getTheXY.theY;
	
					cute.style.left = theX + 'px';
					cute.style.top = theY + 'px';
					cute.style.backgroundPosition = '-' + theX + 'px -' + theY + 'px';
				}).on('mouseup', function (e, diff) {
					var _me$getTheXY2 = me.getTheXY(diff, nowX, nowY, maxX, maxY),
					    theX = _me$getTheXY2.theX,
					    theY = _me$getTheXY2.theY;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".limit-cropper {\n  display: inline-block;\n  position: relative;\n}\n.limit-cropper .cropper-mock {\n  position: absolute;\n  width: 100%;\n  height: 100%;\n  z-index: 1;\n  top: 0;\n  left: 0;\n  background: rgba(0, 0, 0, 0.5);\n}\n.limit-cropper .cropper-cute {\n  position: absolute;\n  z-index: 2;\n  width: 200px;\n  height: 200px;\n  background: #FFF no-repeat 0 0;\n  cursor: move;\n}\n", ""]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Controller = function (_Control) {
		...
		_createClass(Controller, [{
			key: 'onChangePos',
			value: function onChangePos(x, y) {
				var me = this;
				var state = me.state,
				    props = me.props;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Controller = function (_Control) {
		...
		_createClass(Controller, [{
			key: 'onChangeSrc',
			value: function onChangeSrc(src) {
				var me = this;
				var state = me.state;
