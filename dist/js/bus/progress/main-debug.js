 ...
 * 业务
 */
define("bus/progress/main-debug", [ "modules/progress/main-debug", "modules/pie/main-debug", "common/methodUtil-debug" ], function(require, exports, module) {
    //依赖
    var Progress = require("modules/progress/main-debug");
    //组件的使用
    var p = new Progress({
        element: "#progress"
    });
