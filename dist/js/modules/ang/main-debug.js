 ...
 * 进度类
 */
define("modules/ang/main-debug", [ "common/jQuery-debug", "common/limit-debug", "common/widget-debug", "common/domUtil-debug", "./compileObject-debug", "common/class-debug", "./compileDom-debug" ], function(require, exports, module) {
    // 依赖
    var $ = require("common/jQuery-debug"), limit = require("common/limit-debug"), Widget = require("common/widget-debug"), CompileObject = require("./compileObject-debug"), CompileDom = require("./compileDom-debug");
    // 类
 ...
 * 编译对象
 */
define("modules/ang/compileObject-debug", [ "common/class-debug" ], function(require, exports, module) {
    // 依赖
    var Class = require("common/class-debug");
    // 类
    var CompileObject = Class.create({
        ...
        // 编译方法
        formate: function() {
            var me = this, soure = me.get("soure"), value = {};
 ...
 * 编译对象
 */
define("modules/ang/compileDom-debug", [ "common/class-debug" ], function(require, exports, module) {
    // 依赖
    var Class = require("common/class-debug");
    // 类
    var CompileDom = Class.create({
        // 类名
        className: "CompileDom",
        // 编译
        compile: function() {}
    });
    // 接口
    module.exports = CompileDom;
});
