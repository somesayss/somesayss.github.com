 ...
 * 进度类
 */
define("modules/ang/main-debug", [ "./compileObject-debug", "common/base-debug" ], function(require, exports, module) {
    // 依赖
    var CompileObject = require("./compileObject-debug");
 ...
 * 编译对象
 */
define("modules/ang/compileObject-debug", [ "common/base-debug" ], function(require, exports, module) {
    // 依赖
    var Base = require("common/base-debug");
    // 类
    var CompileObject = Base.extend({
        attrs: {
            "1": "1"
        },
        // 类名
